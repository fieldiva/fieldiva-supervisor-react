...
const ReportFilterModal = () => {
  const filter = useSelector((state) => state?.modal?.reportFilter);
  const dispatch = useDispatch();

  const handleCancel = () => {
    dispatch(toggleReportFilter());
  };
  ...
  return (
    <Modal
      ...
      open={filter}
      footer={null}
      className="report-filter-modal !w-[400px]"
      closeIcon={false}
      zIndex={1050}
    ...
    >
      ...
      <div className="mt-4 ">
        ...
        <div className="flex flex-col p-2 rounded-lg">
          <Radio.Group className="w-full radio-group !text-black">
